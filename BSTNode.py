class BSTNode:
    ...
    def put(self, key):
        """Insert a new key into the tree rooted at this node."""
        if key < self.key:
    ...
    def pre_order(self):
        """Generator based iteration. Returns items in pre-order."""
        yield self.key
    ...
    def post_order(self):
        """Generator based iteration. Returns items in post-order."""
